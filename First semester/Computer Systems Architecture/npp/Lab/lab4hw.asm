...
segment code use32 class=code
    start:
        ...
        pop EAX
        mov CL, 16
        rol EAX, CL ; EAX = 10101101100111110000000000000000
        or EBX, EAX ; EBX = 10101101100111110000001111101100(2)=AD9F03EC(16)
        mov [c], EBX
